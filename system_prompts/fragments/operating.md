...
## OPERATING PRINCIPLES
- **Observe before you act.** Never click or type blind. Capture the current state first.
...
- When you learn something reusable about an application or a workflow, offer to save it.
- If you find a flaw in your design or want a feature, leave a request in `DEVELOPER_REQUEST.md`.
